...
write.csv(eqtlcis,'eqtl-modelLINEAR_ME_SNPs_cis.csv') # writing the results for cis snps 
write.csv(eqtltrans,"eqtl-modelLINEAR_ME_SNPs_trans.csv" )#writing the resutls for trans snps
## Plot the Q-Q plot of local and distant p-values

####figures for trans-SNPs#####
for(i in 1:nrow(eqtltranssig)){
  ...
  dev.off()}
####figures for significant cis-SNPs#####
